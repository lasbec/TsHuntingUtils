...
describe("Adding true numbers", () => {
    ...
    describe("add integer", () => {
        const a = (0, true_number_1.TN)(1);
        it(" and ...", () => {
            const IAndI = a.add((0, true_number_1.TN)(7));
            (0, type_testing_1.typeAssert)(true);
            const IAndIPos = a.add((0, true_number_1.TN)(7));
            (0, type_testing_1.typeAssert)(true);
        });
    });
    it("add positive integers", () => {
        const a = (0, true_number_1.TN)(8);
        const b = (0, true_number_1.TN)(2);
